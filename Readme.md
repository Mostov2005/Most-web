...
│   ├── profile_window.py      # Окно пользователя
...
<div style="text-align: center;">
  <img src="Screenshots\profile_window.png" alt="Мой скриншот" />
</div>
...
### 1.1.1 Release (08.11.2025)

- Добавлено окно пользователя, где можно просматривать историю заказов
- Текст с именем пользователя на главном окне стал кнопкой
